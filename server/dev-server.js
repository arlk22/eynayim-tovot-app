...
import mokadAuth from '../api/mokad-auth.js';
import mokadReports from '../api/mokad/reports.js';
import mokadReportDetail from '../api/mokad/report-detail.js';
import mokadAttachPatrol from '../api/mokad/attach-patrol.js';
import mokadAddLogEntry from '../api/mokad/add-log-entry.js';
...
app.all('/api/mokad-auth', mokadAuth);
app.all('/api/mokad/reports', mokadReports);
app.all('/api/mokad/report-detail', mokadReportDetail);
app.all('/api/mokad/attach-patrol', mokadAttachPatrol);
app.all('/api/mokad/add-log-entry', mokadAddLogEntry);
